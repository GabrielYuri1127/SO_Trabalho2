...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_execucao.png}
    \caption{Simulacao em execucao. A tela mostra funcionarios trabalhando ao mesmo tempo, fila de atendimentos, logs, receita e progresso.}
