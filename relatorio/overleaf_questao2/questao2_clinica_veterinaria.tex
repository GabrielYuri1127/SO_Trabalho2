...
% \usepackage{listings}
%
\definecolor{q2codegreen}{RGB}{0,115,0}
\definecolor{q2codegray}{RGB}{90,90,90}
\definecolor{q2codepurple}{RGB}{150,0,150}

\lstdefinestyle{JavaStyle}{
  language=Java,
  basicstyle=\ttfamily\small,
  keywordstyle=\color{blue}\bfseries,
  commentstyle=\color{q2codegreen},
  stringstyle=\color{q2codepurple},
  numbers=left,
  numberstyle=\tiny\color{q2codegray},
  numbersep=8pt,
  breaklines=true,
  frame=single,
  tabsize=4,
...
\section{Questao 2: Simulacao de Clinica Veterinaria em Tempo Real}

A segunda parte do trabalho consiste em uma aplicacao que demonstra o uso de threads em uma situacao mais proxima de um sistema real. O tema escolhido foi uma clinica veterinaria em tempo real, pois esse ambiente permite representar atividades simultaneas, como chegada de animais, cadastro na recepcao, atendimento por funcionarios, exames, vacinacao, banho e tosa e casos emergenciais.

A aplicacao foi implementada em duas versoes: uma sequencial, sem uso de threads, e outra concorrente, com recepcao e funcionarios executando em threads separadas. A comparacao entre as duas versoes permite observar a diferenca entre um fluxo unico de atendimento e uma simulacao em que varias tarefas podem ocorrer ao mesmo tempo.

Para tornar a simulacao mais completa, cada atendimento possui informacoes do pet e do tutor. Foram incluidos nome do animal, especie, raca, sexo, nome do tutor, telefone, bairro, servico solicitado, ocorrencia do atendimento, funcionario responsavel e valor simulado do servico. Esses dados aparecem nos logs, nas tabelas da interface e no historico final.

\subsection{Versao sequencial}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_inicial.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_execucao_fila.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_execucao_equipe.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_historico_parcial.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_final_historico.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{overleaf_questao2/imagens/q2_interface_final_equipe.png}
...
\subsection{Conclusao da Questao 2}
